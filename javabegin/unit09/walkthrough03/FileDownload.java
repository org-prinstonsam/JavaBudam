...
/*    if (args.length!=2){
  ...
  {
      URL remoteFile = new URL("http://myflex.org/yf/podru/budam438.mp3");
    /*URL remoteFile=new URL(args[0]);*/
    URLConnection fileStream=remoteFile.openConnection();

    // Open output and input streams
      fOut = new FileOutputStream("budam438.mp3");
    ...
    while((data=in.read())!=-1){
     ...
     e.printStackTrace();
	  ...
	  System.out.println("The file " + "http://myflex.org/yf/podru/budam438.mp3" +
